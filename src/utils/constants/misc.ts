import { BarChart3Icon, FolderOpenIcon, Store, WandSparklesIcon } from "lucide-react";
...
export const PROCESS = [
    {
        ...
        description: "Get your Shopify store ready with Drpshippr — complete with branded design, payment gateways, and winning products.",
        icon: Store,
    },
    {
        title: "Run Ads & Automate Orders",
        description: "Drpshippr launches AI-driven ad campaigns and syncs every Shopify order into your dashboard with automated confirmations.",
        icon: WandSparklesIcon,
    },
    {
        title: "Deliver & Scale Faster",
        description: "Orders are shipped, COD calls confirmed by AI agents, and RTO minimized — so you focus on growing your brand.",
        icon: BarChart3Icon,
    },
] as const;
