    ...
    return (
        ...
        >
            ...
            <text
                ...
                strokeWidth="0.3"
                className="font-[helvetica] font-bold stroke-neutral-800 fill-transparent text-5xl"
            ...
            <motion.text
                ...
                dominantBaseline="middle"
                strokeWidth="0.3"
                className="font-[helvetica] font-bold fill-transparent text-5xl stroke-neutral-800"
